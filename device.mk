...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZE554KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZE554KL.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZE554KL_24bit.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZE554KL_24bit.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_ZE554KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_ZE554KL.xml \
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.hardware.camera.manual_postprocessing.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.camera.manual_postprocessing.xml \
    frameworks/native/data/etc/system/android.hardware.camera.manual_sensor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.camera.manual_sensor.xml \
    ...
    frameworks/native/data/etc/system/android.hardware.ethernet.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.ethernet.xml \
...
# Inherit vendor
$(call inherit-product, vendor/asus/croissant/croissant-vendor.mk)
